...
| **Campaign** | **`/campaign`** | **Compete** — 3-day seasons, attempts limits, private timer, public leaderboard | **Yes** (Artifact 6 MVP UI + Artifact 5 APIs) — requires Google sign-in to play |
...
| **Campaign seasons** (3-day) | Shared 20-prompt set; leaderboard; scoring `v1_correct_diff_cover` | **MVP shipped** (Artifacts 3–6); hardening still planned (#10) |
