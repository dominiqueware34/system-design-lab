...
/**
 * Free practice problem list (moved from hub `/` to `/practice`).
 */
    ...
    <div>
      ...
      {(track === "all" || track === "agentic") && (
        <p className="mb-6 flex items-start gap-2 rounded-lg border border-violet-500/20 bg-violet-500/5 px-3 py-2 text-xs text-zinc-400">
          ...
          Agentic tips: wire{" "}
          <strong className="font-medium text-zinc-300">Agent → Tool → Agent</strong> for
          multi-step feedback, pick an{" "}
          <strong className="font-medium text-zinc-300">LLM model</strong>, parallelize with
          multi-agent / fan-out, and add{" "}
          <strong className="font-medium text-zinc-300">span or e2e evals</strong> — the
